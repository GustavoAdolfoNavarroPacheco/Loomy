  ...
  return (
    <div className={cn("relative h-screen flex flex-col w-full overflow-hidden", getThemeClass(pathname))}>
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -top-32 -left-32 h-[26rem] w-[26rem] rounded-full opacity-40 blur-3xl" style={{ background: 'hsl(var(--module))' }} />
        <div className="absolute top-1/3 -right-24 h-[22rem] w-[22rem] rounded-full opacity-30 blur-3xl" style={{ background: 'hsl(var(--module))' }} />
        <div className="absolute -bottom-24 left-1/3 h-80 w-80 rounded-full opacity-25 blur-3xl" style={{ background: 'hsl(var(--module))' }} />
        <div className="absolute top-1/4 left-1/2 h-64 w-64 rounded-full opacity-20 blur-3xl" style={{ background: 'hsl(var(--module))' }} />
      </div>
