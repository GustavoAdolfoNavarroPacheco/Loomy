  ...
  return (
    <div className="space-y-8 p-1 md:p-2 max-w-[1600px] mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="shadow-md border-muted/30 bg-card/50 backdrop-blur-sm">
        ...
        <Card className="shadow-md border-muted/30 bg-card/50 backdrop-blur-sm flex flex-col">
          <CardHeader className="border-b bg-muted/5">
            <CardTitle className="text-lg font-bold flex items-center gap-2">
